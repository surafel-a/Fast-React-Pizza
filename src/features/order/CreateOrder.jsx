      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            {formErrors?.phone && <p className="text-xs text-red-700 bg-red-100 mt-2 p-2 rounded-md">{formErrors.phone}</p>}
          </div>
        </div>
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center relative">
          ...
          <div className="grow">
            <input 
              ...
              type="text" name="address" required disabled={isLoadingAddress} />
              {addressStatus ===  'error' && <p className="text-xs text-red-700 bg-red-100 mt-2 p-2 rounded-md">{errorAddress}</p>}
          </div>
          {!position.latitude && !position.longitude &&
            <span className="absolute right-[3px] z-50 top-[3px] md:right-[5px] md:top-[5px]">
            <Button disabled={isLoadingAddress} defaultValue={address} type="small" onClick={(e) => {
              e.preventDefault();
